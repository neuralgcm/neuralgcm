...
class Model(nnx.Module, abc.ABC):
  ...
  def vectorize(
    ...
    vectorized = VectorizedModel(self)
    return vectorized.vectorize(vectorization_specs)
...
class VectorizedModel(Model):
  ...
  def vectorize(
    ...
    graph_def, state_to_clone, state_to_merge = nnx.split(
        self.vectorized_model, vectorized_filters, ...
    )
  ...
  def assimilate(self, inputs: typing.Observation) -> None:
    ...
    v_axis = self._v_coord_for_filter(typing.Prognostic)
  ...
  def update_dynamic_inputs(
    ...
    v_axis = self._v_coord_for_filter(typing.DynamicInput)
  ...
  def initialize_random_processes(self, rng: cx.Field) -> None:
    ...
    v_axis = self._v_coord_for_filter(typing.Randomness)
  ...
  def reset_diagnostic_state(self):
    ...
    v_axis = self._v_coord_for_filter(typing.Diagnostic)
