...
FinalizedQuerySpec: TypeAlias = data_specs.FinalizedQuerySpec
...
ConcreteSpecs: TypeAlias = (
    dict[str, dict[str, FinalizedQuerySpec]] | dict[str, FinalizedQuerySpec]
)
...
def _get_coord(spec: FinalizedQuerySpec) -> cx.Coordinate:
...
def _extract_timedelta(
  ...
  coordinate = _get_coord(coordinate)
